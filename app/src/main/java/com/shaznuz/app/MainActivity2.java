...
public class MainActivity2 extends AppCompatActivity {
    ...
    private static String webview_url   = "https://www.shaznuz.com";    // web address or local file location you want to open in webview
 ...
 WebView webView;
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        webSettings.setUserAgentString("shaznuz");
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
                ...
                if(file_permission() && Build.VERSION.SDK_INT >= 21) {
                    ...
                    if (includePhoto) {
                        ...
                        if (takePictureIntent.resolveActivity(MainActivity2.this.getPackageManager()) != null) {
                            File photoFile = null;
                            try {
                    ...
                    if (includeVideo) {
                        ...
                        if (takeVideoIntent.resolveActivity(MainActivity2.this.getPackageManager()) != null) {
                            File videoFile = null;
                            try {
    ...
    public class Callback extends WebViewClient {
        ...
        public void onPageFinished(WebView view, String url)
        {
            ...
            webView.loadUrl("javascript:(function() { " +
                    "document.getElementById('shaznuz-app').style.display='none';})()");
        }
