...
public class MainActivity3 extends AppCompatActivity{
    ...
    private static String webview_url   = "https://www.facebook.com";    // web address or local file location you want to open in webview
            ...
            public boolean onShowFileChooser(WebView webView, ValueCallback<Uri[]> filePathCallback, FileChooserParams fileChooserParams) {
                ...
                if(file_permission() && Build.VERSION.SDK_INT >= 21) {
                    ...
                    if (includePhoto) {
                        ...
                        if (takePictureIntent.resolveActivity(MainActivity3.this.getPackageManager()) != null) {
                            File photoFile = null;
                            try {
                    ...
                    if (includeVideo) {
                        ...
                        if (takeVideoIntent.resolveActivity(MainActivity3.this.getPackageManager()) != null) {
                            File videoFile = null;
                            try {
    ...
    public boolean file_permission(){
        if(Build.VERSION.SDK_INT >=23 && (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE) != PackageManager.PERMISSION_GRANTED || ContextCompat.checkSelfPermission(this, Manifest.permission.CAMERA) != PackageManager.PERMISSION_GRANTED)) {
            ActivityCompat.requestPermissions(MainActivity3.this, new String[]{Manifest.permission.WRITE_EXTERNAL_STORAGE, Manifest.permission.CAMERA}, 1);
            return false;
        }else{
            return true;
        }
